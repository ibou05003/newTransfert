...
// Returns the private 'App\Repository\MotDePasseRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MotDePasseRepository.php';

return $this->privates['App\\Repository\\MotDePasseRepository'] = new \App\Repository\MotDePasseRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
